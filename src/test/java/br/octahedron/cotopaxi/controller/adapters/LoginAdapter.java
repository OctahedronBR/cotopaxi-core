 ...
 */
public class LoginAdapter extends InputAdapter {

	public LoginAdapter() {
		this.addAttribute("login", SafeStringConverter.class);
		this.addAttribute("roles", StringCommaSeparatedArrayConverter.class);
	}
}
