...
/**
 * Represents a {@link ModelAttribute} that encapsulate other {@link ModelAttribute}s internally.
 * It useful to receive an fulfilled object as parameter instead of receive each attribute separately. 
 * 
...
public class ObjectModelAttribute<T> implements ModelAttribute<T> {
	 ...
	 * @param internalAttribute the {@link ModelAttribute} to be added
	 */
