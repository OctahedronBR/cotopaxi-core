...
/**
 * A {@link ComparableRule} that checks if an input is LESS THAN the base value.
 * 
 ...
 */
public class LessThanRule extends ComparableRule {

	/**
	 * @see ComparableRule
	 */
	public LessThanRule(Input baseInput, Converter<?> converter) {
	 ...
	 * @see ComparableRule
	 */
	public LessThanRule(String message, Input baseInput, Converter<?> converter) {
	 ...
	 * @see ComparableRule
	 */
	public <T> LessThanRule(Converter<T> converter, T baseLiteral) {
	 ...
	 * @see ComparableRule
	 */
	public <T> LessThanRule(String message, Converter<T> converter, T baseLiteral) {
