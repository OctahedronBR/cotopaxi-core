...
public class MetatadaMapper {
	...
	public MetatadaMapper(String[] modelFacadesClassesNames) throws ClassNotFoundException, SecurityException, NoSuchMethodException {
	...
	/**
	 * @see MetatadaMapper#getMapping(ServletRequestWrapperImpl)
	 * @param url
	 ...
	 *            {@link MetatadaMapper#getURLKey(String, HTTPMethod)} method.
